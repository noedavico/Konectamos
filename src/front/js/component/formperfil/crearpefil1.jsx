...
export const Crearperfil1  = () => {
    ...
    async function handleperfi(e) {
      e.preventDefault()
      let isLogged = await actions.CreacionPerfil(numTelefono,fechaNacimiento,genero);
      if(isLogged){//true
	 ...
	 return (
        ...
        <div class="container col-10 m-auto ">
          <div class="d-flex justify-content-between align-items-lg-center py-3 flex-column flex-lg-row">
            <h2 class="h5 mb-3 mb-lg-0"><a href="../../registropag2" class="text-muted"><i class="bi bi-arrow-left-square me-2"></i></a> Crea tu perfil </h2>
          </div>
            ...
            <div class="col-lg-8">
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <select class="form-select" onChange={(e)=>setGenero(e.target.value)} value={genero}>
                  ...
                  onChange={(e)=>setFotografia(e.target.value)} value={fotografia}/>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="container  m-auto gap-3">
             ...
             <Link to="/crearperfil2"> <button class="btn btn-primary btn-sm btn-icon-text"><i class=""></i> <span class="text">Siguiente</span></button> </Link>
            </div>
        </div>
