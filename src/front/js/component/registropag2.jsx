...
<div className="container mt-4">
    <div className="row text-center">
        ...
        <div className="col-xl-4 col-sm-6 mb-5 position-relative" onClick={() => setSubCategoria("peques")}>
        ...
        <div className="col-xl-4 col-sm-6 mb-5 position-relative" onClick={() => setSubCategoria("adultos")}>
        ...
        <div className="col-xl-4 col-sm-6 mb-5 position-relative" onClick={() => setSubCategoria("mascotas")}>
