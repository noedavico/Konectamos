        ...
        <div className="row text-center">
          <div role="button" tabIndex="0" className="col-lg-4 col-12 mb-5 position-relative" onClick={() => ajusteCategoria("peques")}>
            ...
            <div className=" rounded shadow-sm py-5 px-4 fondoclaro" style={{ height: "250px" }} >
              ...
              <span className="small text-uppercase  text-white"> Acompañamiento y recogida del colegio, ayuda de última hora, días de semana ,fines de semana, noches y mas... </span>
            </div>
          </div>
          ...
          <div role="button" tabIndex="0" className="col-lg-4 col-12 mb-5 mt-5 mt-lg-0 position-relative" onClick={() => ajusteCategoria("mayores")}>
            ...
            <div className="rounded shadow-sm py-5 px-4 fondoclaro" style={{ height: "250px" }} >
              ...
              <span className="small text-uppercase  text-white">Cuidado, Acompañiamiento, Ocio,  ayuda en el día a día, cuidado de tiempo completo o parcial y  mas.</span>
            </div>
          </div>
          ...
          <div role="button" tabIndex="0" className="col-lg-4 col-12 mb-5 mt-5 mt-lg-0 position-relative" onClick={() => ajusteCategoria("mascotas")}>
            ...
            <div className=" rounded shadow-sm py-5 px-4 fondoclaro" style={{ height: "250px" }} >
              ...
              <span className="small text-uppercase  text-white"> Paseo, Familia de acogida, Entrenadores, Guardería de Día, juegos, y mas.. <br /></span>
            </div>
          </div>
        </div>
      </div>
