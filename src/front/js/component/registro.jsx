                ...
                <form onSubmit={handleSingup}>
                  <div className="row">
                    ...
                    <div className="mx-3 mb-3 form-check">
                      <input type="checkbox" className="form-check-input" id="condiciones" value={checkConditions} onClick={e => setCheckConditions(e.target.value)} />
                      <label className="form-check-label" htmlFor="condiciones">Al registrarte, estás de acuerdo con las condiciones de
                        uso.</label>
                    </div>
                    ...
                    <div className="row  w-100 m-auto justify-content-center align-items-center">
                      <div className="col-6 ">
                        <Link className="btn btn-primary btn-block py-2 btn-facebook mx-1 mb-2" to='#'>
                          <i className="fa-brands fa-facebook-f" /><span className="font-weight-bold"> Continua con Facebook</span>
                        </Link>
                      </div>
