...
Revision ID: 4627878787d4
Revises: 
Create Date: 2023-03-22 01:56:26.209422
...
def upgrade():
    ...
    sa.Column('servicios', sa.String(length=120), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('servicio_adicional', sa.String(length=120), nullable=True),
    sa.Column('edades', sa.String(length=120), nullable=True),
    sa.Column('cualificacion', sa.String(length=120), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('peques_id', sa.Integer(), nullable=False),
    ...
    sa.Column('foto_imagen', sa.Integer(), nullable=True),
